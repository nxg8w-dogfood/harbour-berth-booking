...
- Started as: a repository we already own, brought under governance
...
_Location not recorded — ask._

This project starts from working code. **Do not restructure it to match a template.** Add
what is missing — documentation, CI, licence — and leave the source layout alone. If it
came from an AI tool, assume credentials are in the git history until you have checked,
and rotate anything you find: deleting the line does not remove it from history.
